...
dynamics.  Reward and success rate rise steeply over the first
200 iterations as the policy masters flat terrain, then continue
climbing as the adaptive curriculum exposes progressively harder
obstacles.  By iteration~400, the curriculum has reached its
maximum difficulty level and success saturates near~100\%.

\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{figures/teacher_training.pdf}
  \caption{Teacher training curves.}
