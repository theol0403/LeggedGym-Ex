...
All experiments use the Genesis GPU simulator~\cite{genesis2024}
with the legged\_gym framework~\cite{rudin2022learning} and
rsl\_rl~\cite{schwarke2025rslrl} on 4$\times$ NVIDIA L40S GPUs.
The Unitree Go2 quadruped has 12 actuated joints.
