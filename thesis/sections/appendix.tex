...
This appendix lists all training hyperparameters used in the
experiments.  Unless otherwise noted, values are shared across all
runs.
...
rate exceeds 85\% and regress when it drops below 40\%.
