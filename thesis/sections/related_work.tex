...
hardware~\citep{hwangbo2019learning, fu2021minimizing, rudin2022learning}.
Lee~et~al.~\cite{lee2020learning} pioneered the privileged
teacher--student paradigm for locomotion: a teacher trains with access
to ground-truth terrain and physics parameters, then a student imitates
the teacher from proprioceptive history alone, achieving zero-shot
sim-to-real transfer on rough terrain.
