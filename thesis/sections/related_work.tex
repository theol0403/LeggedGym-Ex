...
from proprioceptive history alone and achieving zero-shot sim-to-real
...
depth estimation across diverse datasets.
Depth~Anything~V2 (DA2)~\citep{yang2024depth} achieves state-of-the-art
zero-shot depth estimation using a vision transformer encoder trained
on 142M images.
