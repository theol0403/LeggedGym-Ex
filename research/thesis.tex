...
ground-truth depth upper bound.  Domain invariance experiments under
visual perturbations show that DA2 provides strong robustness to
color and brightness changes ($\leq$5.5~pp drop at moderate severity)
and generalizes across structured textures ($-$7~pp for brick
patterns), while featureless surfaces cause failure---reflecting an
input requirement of monocular depth estimation rather than a domain
